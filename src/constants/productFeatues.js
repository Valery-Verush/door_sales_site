export const productFeatues = [
  ...
  { name: 'itemheight', label: 'Высота', default: '2000' },
  { name: 'itemwidth', label: 'Ширина', default: '800' },
  { name: 'glass', label: 'Вариант стекла', default: '-' },
  { name: 'series', label: 'Серия', default: '23S(р)' },
];
